...
# Create exotic pets
# Create exotic pets
pet1 = ExoticPet.create!(name: 'Hamster', age: 3, description: 'A wild hamster with majestic stripes.', image_url: 'https://plus.unsplash.com/premium_photo-1695410374501-43ba3c8ebca4?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8aGFtc3RlcnxlbnwwfHwwfHx8MA%3D%3D', user: user1, price_per_day: 10)
pet2 = ExoticPet.create!(name: 'Parrot', age: 2, description: 'A colorful parrot with vibrant feathers.', image_url: 'https://images.unsplash.com/photo-1452570053594-1b985d6ea890?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cGFycm90fGVufDB8fDB8fHww', user: user2, price_per_day: 15)
...
pet4 = ExoticPet.create!(name: 'Chameleon', age: 4, description: 'A chameleon that can change its colors.', image_url: 'https://plus.unsplash.com/premium_photo-1687773506111-615a26684e1f?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Y2hhbWVsZW9ufGVufDB8fDB8fHww', user: user4, price_per_day: 18)
pet5 = ExoticPet.create!(name: 'Iguana', age: 2, description: 'A majestic iguana to keep you company.', image_url: 'https://images.unsplash.com/photo-1542313337-c6a6ffb1ac12?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aWd1YW5hfGVufDB8fDB8fHww', user: user5, price_per_day: 20)
